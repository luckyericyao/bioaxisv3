  ...
  return (
    <section className="border-t border-bioaxis-line bg-[radial-gradient(circle_at_18%_0%,rgba(56,189,248,0.18),transparent_24rem),radial-gradient(circle_at_86%_0%,rgba(16,185,129,0.12),transparent_22rem),linear-gradient(180deg,#eef3f8_0%,#f8fafc_100%)]">
      <div className="mx-auto grid w-full max-w-7xl gap-6 px-5 py-14 sm:px-8 lg:grid-cols-[1fr_auto] lg:items-center lg:px-10">
        <div>
          <p className="text-sm font-semibold uppercase text-bioaxis-accent">Ready to structure your sourcing request?</p>
          <h2 className="mt-3 text-3xl font-bold uppercase text-bioaxis-text sm:text-4xl">Send the list. BioAxis will structure the sourcing path.</h2>
          <p className="mt-4 max-w-2xl text-sm leading-6 text-bioaxis-muted">
            Paste SKUs, catalog references, supplier lines, or a messy product list. BioAxis helps
            organize equivalent review, samples, documents, RFQ details, and recurring supply
            context.
          </p>
        </div>
